...
namespace Hawaii
{
    namespace SystemPreferences
    {
        ...
        class DesktopPlugin : public PreferencesModulePlugin
        {
            Q_OBJECT
            Q_PLUGIN_METADATA(IID "org.hawaii.SystemPreferences.PreferencesModuleFactoryInterface" FILE "keyboard.json")
        public:
